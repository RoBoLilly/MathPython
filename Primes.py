#!/usr/bin/env python
# coding: utf-8
# Lilly Fiorino created Feb 06, 2021
...
# print("Primes from 1 to (100) = ", primes(100))
...
# timerStart = time.perf_counter()
# print("factors_slow(5345623) = ", factors_slow(5345623))
# timerEnd = time.perf_counter()
# print(f"Time in {timerEnd - timerStart:0.7f}(s)")

# timerStart = time.perf_counter()
# print("factors(5345623) = ", factors_slow(5345623))
# timerEnd = time.perf_counter()
# print(f"Time in {timerEnd - timerStart:0.7f}(s)")

# print(GCD(7473, 15953))
